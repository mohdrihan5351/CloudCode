...
export const RocketIcon = ({ className }: { className?: string }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="m15 12 3 3"></path><path d="m21 21-1.5-1.5"></path>
    </svg>
);
...
export const SparkleIcon = ({ className }: { className?: string }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9.93 2.5a2.5 2.5 0 0 1 4.14 0l.53 1.06a.5.5 0 0 0 .5.27l1.17.17a2.5 2.5 0 0 1 2.75 2.75l-.17 1.17a.5.5 0 0 0 .27.5l1.06.53a2.5 2.5 0 0 1 0 4.14l-1.06.53a.5.5 0 0 0-.27.5l-.17 1.17a2.5 2.5 0 0 1-2.75 2.75l-1.17-.17a.5.5 0 0 0-.5.27l-.53 1.06a2.5 2.5 0 0 1-4.14 0l-.53-1.06a.5.5 0 0 0-.5-.27l-1.17-.17a2.5 2.5 0 0 1-2.75-2.75l.17-1.17a.5.5 0 0 0-.27-.5l-1.06-.53a2.5 2.5 0 0 1 0-4.14l1.06-.53a.5.5 0 0 0 .27-.5l.17-1.17A2.5 2.5 0 0 1 8.2 3.9l1.17.17a.5.5 0 0 0 .5-.27l.53-1.06z"/></svg>
);
...
export const MaximizeIcon = ({ className }: { className?: string }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M8 3H5a2 2 0 0 0-2 2v3m18 0V5a2 2 0 0 0-2-2h-3m0 18h3a2 2 0 0 0 2-2v-3M3 16v3a2 2 0 0 0 2 2h3"/></svg>
);

export const LaptopIcon = ({ className }: { className?: string }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 16V7a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v9m16 0H4m16 0 1.28 2.55A1 1 0 0 1 20.28 20H3.72a1 1 0 0 1-.9-1.45L4 16"/></svg>
);
